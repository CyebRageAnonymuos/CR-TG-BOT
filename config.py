...
# قالب: (عنوان, قیمت GRAM, قیمت TRX, قیمت USDT, قیمت استارز)
DEFAULT_MULTI_PLANS = [
    ("تک کاربره نامحدود یک‌ماهه", 2.5, 25, 2.5, 20),
    ("دو کاربره نامحدود یک‌ماهه", 4.5, 45, 4.5, 35),
    ("تک کاربره نامحدود دو‌ماهه", 4.5, 45, 4.5, 35),
    ("دو کاربره نامحدود دو‌ماهه", 8, 80, 8, 60),
]
